package com.scooterrental.scooter_rental.security.jwt;
...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<Role> userRoles) {
        ...
        Date expirationDate = new Date(initiatedDate.getTime() + validityInMilliseconds);

        return Jwts.builder()
                .setClaims(claims)
                .setIssuedAt(initiatedDate)
